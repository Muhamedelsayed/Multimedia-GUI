...
class Ui_Form(object):
    ...
    def checkPhotos(self):
        ...
        if os.path.isfile(image_path):
            ...
            if (Mode=="Histogram"):  
                        self.label_7.setPixmap(QtGui.QPixmap("1.jpg").scaled(150, 100, QtCore.Qt.KeepAspectRatio))
                        self.label_3.setPixmap(QtGui.QPixmap("2.jpg").scaled(150, 100, QtCore.Qt.KeepAspectRatio))
                        self.label_4.setPixmap(QtGui.QPixmap("3.jpg").scaled(150, 100, QtCore.Qt.KeepAspectRatio))
                        self.label_5.setPixmap(QtGui.QPixmap("4.jpg").scaled(150, 100, QtCore.Qt.KeepAspectRatio))
                        self.label_6.setPixmap(QtGui.QPixmap("5.jpg").scaled(150, 100, QtCore.Qt.KeepAspectRatio))
                
                ##### 7ot code el Histogram hna ###########   
            
            if (Mode=="Color layout"):
                        self.label_7.setPixmap(QtGui.QPixmap("1.jpg").scaled(150, 100, QtCore.Qt.KeepAspectRatio))
                        self.label_3.setPixmap(QtGui.QPixmap("2.jpg").scaled(150, 100, QtCore.Qt.KeepAspectRatio))
                        self.label_4.setPixmap(QtGui.QPixmap("3.jpg").scaled(150, 100, QtCore.Qt.KeepAspectRatio))
                        self.label_5.setPixmap(QtGui.QPixmap("4.jpg").scaled(150, 100, QtCore.Qt.KeepAspectRatio))
